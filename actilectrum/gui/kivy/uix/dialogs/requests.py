...
<RequestItem@CardItem>
    ...
    status: ''
    date: ''
    icon: 'atlas://actilectrum/gui/kivy/theming/light/important'
    Image:
        id: icon
        source: root.icon
        size_hint: None, 1
...
from actilectrum.gui.kivy.uix.context_menu import ContextMenu

pr_icon = {
    PR_UNPAID: 'atlas://actilectrum/gui/kivy/theming/light/important',
    PR_UNKNOWN: 'atlas://actilectrum/gui/kivy/theming/light/important',
    PR_PAID: 'atlas://actilectrum/gui/kivy/theming/light/confirmed',
    PR_EXPIRED: 'atlas://actilectrum/gui/kivy/theming/light/close'
}
request_text = {
    PR_UNPAID: _('Pending'),

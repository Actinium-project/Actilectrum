...
class SettingsDialog(Factory.Popup):
    ...
    def __init__(self, app):
        ...
        self.config = self.app.actilectrum_config
    ...
    def coinselect_status(self):
        return coinchooser.get_name(self.app.actilectrum_config)
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/proxy.kv')

...
import actilectrum.simple_config as config
    ...
    BoxLayout
        ...
        SendReceiveBlueBottom:
            ...
            BoxLayout:
                ...
                Image:
                    source: 'atlas://actilectrum/gui/kivy/theming/light/globe'
                    size_hint: None, None
                    size: '22dp', '22dp'
                    pos_hint: {'center_y': .5}
                BlueButton:
            ...
            #    height: blue_bottom.item_height
            #    Image:
            #        source: 'atlas://actilectrum/gui/kivy/theming/light/network'
            #        size_hint: None, None
            #        size: '22dp', '22dp'
            #        pos_hint: {'center_y': .5}
            #    BlueButton:
            ...
            BoxLayout:
                ...
                height: blue_bottom.item_height
                Image:
                    source: 'atlas://actilectrum/gui/kivy/theming/light/calculator'
                    size_hint: None, None
                    size: '22dp', '22dp'
                    pos_hint: {'center_y': .5}
                BlueButton:

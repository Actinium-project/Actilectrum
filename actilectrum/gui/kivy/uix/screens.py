...
from actilectrum import bitcoin
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from actilectrum.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def do_share(self):
        uri = self.get_URI()
        self.app.do_share(uri, _("Share Actinium Request"))

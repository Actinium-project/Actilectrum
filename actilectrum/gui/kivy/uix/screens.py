...
from actilectrum.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from actilectrum.util import PR_TYPE_ONCHAIN, PR_TYPE_LN, PR_DEFAULT_EXPIRATION_WHEN_CREATING
from actilectrum import bitcoin, constants
from actilectrum.transaction import Transaction, tx_from_any, PartialTransaction, PartialTxOutput
from actilectrum.util import (parse_URI, InvalidBitcoinURI, PR_PAID, PR_UNKNOWN, PR_EXPIRED,
...
from actilectrum import simple_config
from actilectrum.lnaddr import lndecode, parse_lightning_invoice
from actilectrum.lnutil import RECEIVED, SENT, PaymentFailure
...
Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/history.kv')
Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/send.kv')
Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/receive.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_item): #tx_hash, tx_mined_status, value, balance):
        ...
        if is_lightning:
            ...
            icon = "atlas://actilectrum/gui/kivy/theming/light/lightning"
            ...
            icon = "atlas://actilectrum/gui/kivy/theming/light/" + TX_ICONS[status]
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from actilectrum.util import create_bip21_uri
        amount = self.amount
        if amount:

...
from actilectrum.util import send_exception_to_crash_reporter, parse_URI, InvalidBitcoinURI
from actilectrum.util import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT, TxMinedInfo, get_request_status, pr_expiration_values
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')

...
from actilectrum.wallet import Wallet, InternalAddressCorruption
from actilectrum.paymentrequest import InvoiceStore
...
from actilectrum.util import format_satoshis, format_satoshis_plain
from actilectrum.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='actilectrum.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='actilectrum.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='actilectrum.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='actilectrum.gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='actilectrum.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'actilectrum/gui/kivy/data/fonts/Roboto.ttf',
               'actilectrum/gui/kivy/data/fonts/Roboto.ttf',
               'actilectrum/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'actilectrum/gui/kivy/data/fonts/Roboto-Bold.ttf')


from actilectrum.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from actilectrum.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def show_pr_details(self, req, status, is_invoice):
        from actilectrum.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def build(self):
        return Builder.load_file('actilectrum/gui/kivy/main.kv')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('actilectrum/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='actilectrum.gui.kivy.uix.dialogs')
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Actilectrum', message,
                            app_icon=icon, app_name='Actilectrum')
        except ImportError:
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://actilectrum/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://actilectrum/gui/kivy/theming/light/card'
        else:

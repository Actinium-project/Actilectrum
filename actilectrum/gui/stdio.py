...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'actilectrum create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Actinium address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'actilectrum setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'actilectrum setconfig' to change your settings")
        return True

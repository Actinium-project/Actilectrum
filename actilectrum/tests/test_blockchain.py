...
from actilectrum.blockchain import Blockchain, deserialize_header, hash_header
from actilectrum.util import bh2u, bfh, make_dir
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for Actinium block header #100.

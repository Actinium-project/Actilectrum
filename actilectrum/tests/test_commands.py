...
from actilectrum.util import create_and_start_event_loop
from actilectrum.commands import Commands, eval_bool
from actilectrum import storage, wallet
from actilectrum.wallet import restore_wallet_from_text
...
class TestCommands(ElectrumTestCase):
    ...
    def setUp(self):
        ...
        self.config = SimpleConfig({'actilectrum_pathathathatactilectrum_pathm_pathm_pathm_pathm_pathm_pathm_pathm_pathm_pathm_pathm_pathm_path})
    ...
    def test_setconfig_non_auth_list(self):
        self.assertEqual(['file:///var/www/', 'https://actilectrum.org'],
            Commands._setconfig_normalize_value('url_rewrite', "['file:///var/www/','https://actilectrum.org']"))
        self.assertEqual(['file:///var/www/', 'https://actilectrum.org'],
            Commands._setconfig_normalize_value('url_rewrite', '["file:///var/www/","https://actilectrum.org"]'))
    ...
    def test_setconfig_auth(self):
        ...
        self.assertEqual("['file:///var/www/','https://actilectrum.org']",
            Commands._setconfig_normalize_value('rpcpassword', "['file:///var/www/','https://actilectrum.org']"))

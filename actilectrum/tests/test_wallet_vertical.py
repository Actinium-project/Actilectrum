...
from actilectrum.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet, restore_wallet_from_text
...
class TestWalletSending(TestCaseForTestnet):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.actilectrum_path = tempfile.mkdtemp()
        cls.config = SimpleConfig({'actilectrum_path': cls.actilectrum_path})

    @classmethod
    def tearDownClass(cls):
        super().tearDownClass()
        shutil.rmtree(cls.actilectrum_path)

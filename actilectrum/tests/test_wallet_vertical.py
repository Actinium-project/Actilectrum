...
from actilectrum import storage, bitcoin, keystore, bip32
from actilectrum import Transaction
from actilectrum import SimpleConfig
from actilectrum.address_synchronizer import TX_HEIGHT_UNCONFIRMED, TX_HEIGHT_UNCONF_PARENT
from actilectrum.wallet import sweep, Multisig_Wallet, Standard_Wallet, Imported_Wallet, restore_wallet_from_text, Abstract_Wallet
from actilectrum.util import bfh, bh2u
from actilectrum.transaction import TxOutput, Transaction, PartialTransaction, PartialTxOutput, PartialTxInput, tx_from_any
from actilectrum.mnemonic import seed_type
...
class TestWalletKeystoreAddressIntegrityForMainnet(ElectrumTestCase):
    ...
    def test_actilectrum_seed_standard(self, mock_write):
    ...
    @needs_test_with_all_ecc_implementations
    @mock.patch.object(storage.WalletStorage, '_write')
    def test_actilectrum_seed_segwit(self, mock_write):
    ...
    @needs_test_with_all_ecc_implementations
    @mock.patch.object(storage.WalletStorage, '_write')
    def test_actilectrum_seed_segwit_passphrase(self, mock_write):
        seed_words = 'bitter grass shiver impose acquire brush forget axis eager alone wine silver'
        self.assertEqual(seed_type(seed_words), 'segwit')
    ...
    @needs_test_with_all_ecc_implementations
    @mock.patch.object(storage.WalletStorage, '_write')
    def test_actilectrum_seed_old(self, mock_write):
    ...
    @needs_test_with_all_ecc_implementations
    @mock.patch.object(storage.WalletStorage, '_write')
    def test_actilectrum_multisig_seed_standard(self, mock_write):
        ...
        # actilectrum seed: ghost into match ivory badge robot record tackle radar elbow traffic loud
    ...
    @needs_test_with_all_ecc_implementations
    @mock.patch.object(storage.WalletStorage, '_write')
    def test_actilectrum_multisig_seed_segwit(self, mock_write):
        ...
        # actilectrum seed: hedgehog sunset update estate number jungle amount piano friend donate upper wool
...
class TestWalletOfflineSigning(TestCaseForTestnet):
    ...
    @needs_test_with_all_ecc_implementations
    @mock.patch.object(storage.WalletStorage, '_write')
    def test_sending_offline_old_actilectrum_seed_online_mpk(self, mock_write):

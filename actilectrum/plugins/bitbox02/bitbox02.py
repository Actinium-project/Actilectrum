...
from actilectrum import bip32, constants
from actilectrum.i18n import _
from actilectrum.keystore import Hardware_KeyStore
from actilectrum.transaction import PartialTransaction
from actilectrum.wallet import Standard_Wallet, Multisig_Wallet, Deterministic_Wallet
from actilectrum.util import bh2u, UserFacingException
from actilectrum.base_wizard import ScriptTypeNotSupported, BaseWizard
from actilectrum.logging import get_logger
from actilectrum.plugin import Device, DeviceInfo
from actilectrum.simple_config import SimpleConfig
from actilectrum.json_db import StoredDict
from actilectrum.storage import get_derivation_used_for_hw_device_encryption
from actilectrum._ltcbitcoin import OnchainOutputType

import actilectrum.bitcoin as bitcoin
import actilectrum.ecc as ecc
...
class BitBox02Client(HardwareClientBase):
    ...
    def get_xpub(self, bip32_path: str, xtype: str, *, display: bool = False) -> str:
        ...
        if xtype == "p2wpkh":
            if coin_network == bitbox02.btc.ACM:

...
from actilectrum.crypto import aes_encrypt_with_iv, aes_decrypt_with_iv
from actilectrum.i18n import _
from actilectrum.util import log_exceptions, ignore_exceptions, make_aiohttp_session

class LabelsPlugin(BasePlugin):

    def __init__(self, parent, config, name):
        BasePlugin.__init__(self, parent, config, name)
        self.target_host = 'labels.actilectrum.org'
        self.wallets = {}
        self.proxy = None

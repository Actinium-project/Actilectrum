...
from actilectrum.transaction import (Transaction, multisig_script, parse_redeemScript_multisig,
...
from actilectrum.keystore import xpubkey_to_pubkey, Xpub
from actilectrum.util import bfh, bh2u
from actilectrum.crypto import hash_160, sha256
from actilectrum.bitcoin import DecodeBase58Check
...
def recover_tx_from_psbt(first: BasicPSBT, wallet: Abstract_Wallet) -> Transaction:
    # Take a PSBT object and re-construct the Actilectrum transaction object.

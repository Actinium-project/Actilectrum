...
This guide explains how to build Actilectrum binaries for macOS systems.
...
#### 1.2 Build Actilectrum

    cd actilectrum
    ./contrib/osx/make_osx
    
This creates both a folder named Actilectrum.app and the .dmg file.
...
Copy the Actilectrum.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd actilectrum
    ./contrib/osx/package.sh ~/Actilectrum.app/

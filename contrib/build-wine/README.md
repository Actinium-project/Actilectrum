...
These scripts can be used for cross-compilation of Windows Actilectrum executables from Linux/Wine.
...
[that script](https://github.com/Actinium-project/actilectrum/blob/master/.travis.yml) might help.
